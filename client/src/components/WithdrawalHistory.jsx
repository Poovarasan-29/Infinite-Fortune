...
export default function WithdrawalHistory() {
  ...
  useEffect(() => {
    async function getWithdrawalHistoryDatas() {
      const res = await axios.get(
        import.meta.env.VITE_API_URL + "user-withdrawal-history",
        {
          params: {
      ...
      setDatas(res.data.withdrawalHistory);
    }
    getWithdrawalHistoryDatas();
  }, []);
